...
const Beranda = () => {
  ...
  const [value, setValue] = useState(
    `Selamat datang, kami hadir untuk membantu berkolaborasi dan mendukung program Palang Merah Indonesia atau PMI, Jika kamu membutuhkan bantuan bisa menghubungi kami lebih lanjut`
  );
  ...
  const triggerSpeak = () => {
    ...
    alert(
      "Jangan diklik berulang kali jika anda tidak ingin terkena spam suara"
    );
